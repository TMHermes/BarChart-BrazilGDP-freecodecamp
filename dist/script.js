...
d3.json('https://raw.githubusercontent.com/TMHermes/BrazilGDPReference/main/BGDP-data.json').
then(data => {
  svgContainer.
  append('text').
  ...
  attr('x', width / 2 + 120).
  attr('y', height + 50).
  text("More info at https://ibge.gov.br/explica/pib.php").
  attr('class', 'info');
  ...
  attr('height', function (d) {
    return linearScale(d).toFixed(3);
  }).
  attr('index', (d, i) => i).
  style('fill', '#b87333').
  attr('transform', 'translate(60, 0)').
